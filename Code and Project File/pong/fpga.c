...
void cursor(int x, int y)
{
	...
	write_pixel_mouse(x - 3, y + 3, 0xffff);
	write_pixel_mouse(x - 1, y + 2, 0xffff);
	write_pixel_mouse(x - 1, y + 3, 0xffff);
	write_pixel_mouse(x - 2, y + 3, 0xffff);
	write_pixel_mouse(x - 1, y + 4, 0xffff);
	write_pixel_mouse(x - 2, y + 4, 0xffff);
	write_pixel_mouse(x - 2, y + 5, 0xffff);
	write_pixel_mouse(x, y + 1, 0xffff);
	write_pixel_mouse(x, y + 2, 0xffff);
	write_pixel_mouse(x, y + 3, 0xffff);
	write_pixel_mouse(x, y + 4, 0xffff);
}
...
// 	while (y <= x)
// 	{
// 		write_pixel(x + x0, y + y0, color);	  // octant 1
// 		write_pixel(y + x0, x + y0, color);	  // octant 2
// 		write_pixel(-x + x0, y + y0, color);  // octant 4
// 		write_pixel(-y + x0, x + y0, color);  // octant 3
// 		write_pixel(-x + x0, -y + y0, color); // octant 5
// 		write_pixel(-y + x0, -x + y0, color); // octant 6
// 		write_pixel(x + x0, -y + y0, color);  // octant 7
// 		write_pixel(y + x0, -x + y0, color);  // octant 8
// 		y++;
// 		if (decisionOver2 <= 0)
// 		{
// 			decisionOver2 += 2 * y + 1;
...
void text_editor_top_w()
{
	...
	write_string(36, 56, "EXIT");
	write_string(30, 52, "Press ESC to EXIT");
...
void text_editor_top_s()
{
	...
	write_string(31, 52, "Press ESC to EXIT");
}
void text_editor_w()
{
	...
	for (ii = 0; ii < 80; ii++)
	{
		for (jj = 0; jj < 60; jj++)
		{
			volatile char *character_buffer = (char *)(0x09000000 + (jj << 7) + ii);
			*character_buffer = str[ii][jj];
		}
	}
	text_editor_top_w();
